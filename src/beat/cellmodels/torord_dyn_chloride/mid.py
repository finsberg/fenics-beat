# Gotran generated code for the "ToRORd_dyn_chloride_mid" model
...
def init_state_values(**values):
    ...
    """
    # Init values
    # CaMKt=0.0201882, d=-8.334604e-30, ff=1.0, fs=0.9183587, fcaf=1.0,
    # fcas=0.999754, jca=0.9999743, ffp=1.0, fcafp=1.0,
    # nca_ss=0.000533652, nca_i=0.001257861, m=0.0004619565, h=0.8739077,
    # j=0.8737841, hp=0.7478972, jp=0.8735375, mL=9.987709e-05,
    # hL=0.5986118, hLp=0.3339899, a=0.0007994042, iF=0.9997514,
    # iS=0.5702538, ap=0.0004072777, iFp=0.9997514, iSp=0.6351927,
    # C3=0.0005910047, C2=0.000708646, C1=0.9983451, O=0.0003445733,
    # I=1.06423e-05, xs1=0.2642293, xs2=0.0001327348,
    # Jrel_np=-1.300486e-21, Jrel_p=-7.610714e-20, v=-91.33918,
    # nai=15.94867, nass=15.94922, ki=156.7131, kss=156.713,
    # cli=48.91277, clss=48.91274, cai=8.297576e-05, cass=6.642187e-05,
    # cansr=2.012225, cajsr=2.016415
...
def init_parameter_values(**values):
    ...
    """
    # Param values
    # celltype=2, cao=1.8, clo=150.0, ko=5.0, nao=140.0, F=96485.0, R=8314.0,
...
def rhs(states, t, parameters, values=None):
    """
    Compute the right hand side of the ToRORd_dyn_chloride_mid ODE
    """
...
def monitor(states, t, parameters, monitored=None):
    """
    Computes monitored expressions of the ToRORd_dyn_chloride_mid ODE
    """
...
def forward_generalized_rush_larsen(states, t, dt, parameters):
    ...
    Compute a forward step using the generalised Rush-Larsen (GRL1) scheme to\
        the ToRORd_dyn_chloride_mid ODE
    """
